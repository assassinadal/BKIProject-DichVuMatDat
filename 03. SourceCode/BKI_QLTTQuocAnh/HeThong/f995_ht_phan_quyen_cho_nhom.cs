...
namespace BKI_DichVuMatDat.HeThong
{
    public partial class f995_ht_phan_quyen_cho_nhom : Form
    {
        ...
        #region Member
        BKI_DichVuMatDat.US.US_HT_USER_GROUP m_us_ht_user_group = new US_HT_USER_GROUP();
        BKI_DichVuMatDat.DS.DS_HT_USER_GROUP m_ds_ht_user_group = new DS_HT_USER_GROUP();
