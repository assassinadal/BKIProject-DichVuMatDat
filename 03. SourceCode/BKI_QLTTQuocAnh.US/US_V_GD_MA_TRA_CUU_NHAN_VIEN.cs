...
/// Date: 29/02/2016 05:17:38
/// Goal: Create User Service Class for V_GD_MA_TRA_CUU_NHAN_VIEN
///************************************************
/// <summary>
/// Create User Service Class for V_GD_MA_TRA_CUU_NHAN_VIEN
/// </summary>
...
public class US_V_GD_MA_TRA_CUU_NHAN_VIEN : US_Object
{
	private const string c_TableName = "V_GD_MA_TRA_CUU_NHAN_VIEN";
#region "Public Properties"
	...
	public decimal dcID_GD_MA_TRA_CUU_NHAN_VIEN 
	{
		get
		{
			return CNull.RowNVLDecimal(pm_objDR, "ID_GD_MA_TRA_CUU_NHAN_VIEN", IPConstants.c_DefaultDecimal);
		}
		set	
		{
			pm_objDR["ID_GD_MA_TRA_CUU_NHAN_VIEN"] = value;
		}
	}

	public bool IsID_GD_MA_TRA_CUU_NHAN_VIENNull()	{
		return pm_objDR.IsNull("ID_GD_MA_TRA_CUU_NHAN_VIEN");
	}

	public void SetID_GD_MA_TRA_CUU_NHAN_VIENNull() {
		pm_objDR["ID_GD_MA_TRA_CUU_NHAN_VIEN"] = System.Convert.DBNull;
	}
...
#region "Init Functions"
	public US_V_GD_MA_TRA_CUU_NHAN_VIEN() 
	{
		pm_objDS = new DS_V_GD_MA_TRA_CUU_NHAN_VIEN();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_GD_MA_TRA_CUU_NHAN_VIEN(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_GD_MA_TRA_CUU_NHAN_VIEN(decimal i_dbID) 
	{
		pm_objDS = new DS_V_GD_MA_TRA_CUU_NHAN_VIEN();
		pm_strTableName = c_TableName;
