...
/// Date: 22-04-2016 05:02:14
/// Goal: Create User Service Class for V_GD_HOP_DONG_4
///************************************************
/// <summary>
/// Create User Service Class for V_GD_HOP_DONG_4
/// </summary>
...
public class US_V_GD_HOP_DONG_4 : US_Object
{
	private const string c_TableName = "V_GD_HOP_DONG_4";
#region "Public Properties"
	...
	public decimal dcSO_TIEN_MAC_DINH_LCD 
	{
		get
		{
			return CNull.RowNVLDecimal(pm_objDR, "SO_TIEN_MAC_DINH_LCD", IPConstants.c_DefaultDecimal);
		}
		set	
		{
			pm_objDR["SO_TIEN_MAC_DINH_LCD"] = value;
		}
	}

	public bool IsSO_TIEN_MAC_DINH_LCDNull()	{
		return pm_objDR.IsNull("SO_TIEN_MAC_DINH_LCD");
	}

	public void SetSO_TIEN_MAC_DINH_LCDNull() {
		pm_objDR["SO_TIEN_MAC_DINH_LCD"] = System.Convert.DBNull;
	}

	public decimal dcSO_TIEN_LCD_THUC_TE 
	{
		get
		{
			return CNull.RowNVLDecimal(pm_objDR, "SO_TIEN_LCD_THUC_TE", IPConstants.c_DefaultDecimal);
		}
		set	
		{
			pm_objDR["SO_TIEN_LCD_THUC_TE"] = value;
		}
	}

	public bool IsSO_TIEN_LCD_THUC_TENull()	{
		return pm_objDR.IsNull("SO_TIEN_LCD_THUC_TE");
	}

	public void SetSO_TIEN_LCD_THUC_TENull() {
		pm_objDR["SO_TIEN_LCD_THUC_TE"] = System.Convert.DBNull;
	}
...
#region "Init Functions"
	public US_V_GD_HOP_DONG_4() 
	{
		pm_objDS = new DS_V_GD_HOP_DONG_4();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_GD_HOP_DONG_4(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_GD_HOP_DONG_4(decimal i_dbID) 
	{
		pm_objDS = new DS_V_GD_HOP_DONG_4();
		pm_strTableName = c_TableName;
