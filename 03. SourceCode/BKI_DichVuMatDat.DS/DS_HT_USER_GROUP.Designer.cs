...
namespace BKI_DichVuMatDat.DS {
    ...
    public partial class DS_HT_USER_GROUP : global::System.Data.DataSet {
        ...
        public partial class HT_USER_GROUPDataTable : global::System.Data.TypedTableBase<HT_USER_GROUPRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public HT_USER_GROUPRow AddHT_USER_GROUPRow(decimal ID, string USER_GROUP_NAME, string DESCRIPTION) {
...
namespace BKI_DichVuMatDat.DS.DS_HT_USER_GROUPTableAdapters {
    ...
    public partial class HT_USER_GROUPTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[HT_USER_GROUP] WHERE (([ID] = @Original_ID) AND ([USER_GROUP_N" +
                "AME] = @Original_USER_GROUP_NAME) AND ((@IsNull_DESCRIPTION = 1 AND [DESCRIPTION" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[HT_USER_GROUP] ([ID], [USER_GROUP_NAME], [DESCRIPTION]) VALUES" +
                " (@ID, @USER_GROUP_NAME, @DESCRIPTION);\r\nSELECT ID, USER_GROUP_NAME, DESCRIPTION" +
                " FROM HT_USER_GROUP WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[HT_USER_GROUP] SET [ID] = @ID, [USER_GROUP_NAME] = @USER_GROUP_NAME, [DESCRIPTION] = @DESCRIPTION WHERE (([ID] = @Original_ID) AND ([USER_GROUP_NAME] = @Original_USER_GROUP_NAME) AND ((@IsNull_DESCRIPTION = 1 AND [DESCRIPTION] IS NULL) OR ([DESCRIPTION] = @Original_DESCRIPTION)));
SELECT ID, USER_GROUP_NAME, DESCRIPTION FROM HT_USER_GROUP WHERE (ID = @ID)";
        ...
        public virtual int Insert(decimal ID, string USER_GROUP_NAME, string DESCRIPTION) {
        ...
        public virtual int Update(decimal ID, string USER_GROUP_NAME, string DESCRIPTION, decimal Original_ID, string Original_USER_GROUP_NAME, string Original_DESCRIPTION) {
        ...
        public virtual int Update(string USER_GROUP_NAME, string DESCRIPTION, decimal Original_ID, string Original_USER_GROUP_NAME, string Original_DESCRIPTION) {
            return this.Update(Original_ID, USER_GROUP_NAME, DESCRIPTION, Original_ID, Original_USER_GROUP_NAME, Original_DESCRIPTION);
        }
    }
