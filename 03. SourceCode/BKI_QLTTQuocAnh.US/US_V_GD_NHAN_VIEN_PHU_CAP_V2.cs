...
/// Date: 25/05/2016 11:21:32
/// Goal: Create User Service Class for V_GD_NHAN_VIEN_PHU_CAP_V2
///************************************************
/// <summary>
/// Create User Service Class for V_GD_NHAN_VIEN_PHU_CAP_V2
/// </summary>
...
public class US_V_GD_NHAN_VIEN_PHU_CAP_V2 : US_Object
{
	private const string c_TableName = "V_GD_NHAN_VIEN_PHU_CAP_V2";
#region "Public Properties"
	...
	public decimal dcID_NV_PC 
	{
		get
		{
			return CNull.RowNVLDecimal(pm_objDR, "ID_NV_PC", IPConstants.c_DefaultDecimal);
		}
		set	
		{
			pm_objDR["ID_NV_PC"] = value;
		}
	}
	...
	public void SetID_NV_PCNull() {
		pm_objDR["ID_NV_PC"] = System.Convert.DBNull;
	}
	...
	public DateTime datNGAY_LAP_PHU_CAP
	{
		get   
		{
			return CNull.RowNVLDate(pm_objDR, "NGAY_LAP_PHU_CAP", IPConstants.c_DefaultDate);
		}
		set   
		{
			pm_objDR["NGAY_LAP_PHU_CAP"] = value;
		}
	}
	...
	{
		pm_objDR["NGAY_LAP_PHU_CAP"] = System.Convert.DBNull;
	}

	public string strNGUOI_LAP_PHU_CAP 
	{
		get 
		{
			return CNull.RowNVLString(pm_objDR, "NGUOI_LAP_PHU_CAP", IPConstants.c_DefaultString);
		}
		set 
		{
			pm_objDR["NGUOI_LAP_PHU_CAP"] = value;
		}
	}
	...
	public void SetNGUOI_LAP_PHU_CAPNull() {
		pm_objDR["NGUOI_LAP_PHU_CAP"] = System.Convert.DBNull;
	}

	public DateTime datNGAY_SUA_PHU_CAP
	{
		get   
		{
			return CNull.RowNVLDate(pm_objDR, "NGAY_SUA_PHU_CAP", IPConstants.c_DefaultDate);
		}
		set   
		{
			pm_objDR["NGAY_SUA_PHU_CAP"] = value;
		}
	}

	public bool IsNGAY_SUA_PHU_CAPNull()
	{
		return pm_objDR.IsNull("NGAY_SUA_PHU_CAP");
	}

	public void SetNGAY_SUA_PHU_CAPNull()
	{
		pm_objDR["NGAY_SUA_PHU_CAP"] = System.Convert.DBNull;
	}

	public string strNGUOI_SUA_PHU_CAP 
	{
		get 
		{
			return CNull.RowNVLString(pm_objDR, "NGUOI_SUA_PHU_CAP", IPConstants.c_DefaultString);
		}
		set 
		{
			pm_objDR["NGUOI_SUA_PHU_CAP"] = value;
		}
	}
	...
	public void SetNGUOI_SUA_PHU_CAPNull() {
		pm_objDR["NGUOI_SUA_PHU_CAP"] = System.Convert.DBNull;
	}
...
#region "Init Functions"
	public US_V_GD_NHAN_VIEN_PHU_CAP_V2() 
	{
		pm_objDS = new DS_V_GD_NHAN_VIEN_PHU_CAP_V2();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_GD_NHAN_VIEN_PHU_CAP_V2(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_GD_NHAN_VIEN_PHU_CAP_V2(decimal i_dbID) 
	{
		pm_objDS = new DS_V_GD_NHAN_VIEN_PHU_CAP_V2();
		pm_strTableName = c_TableName;
